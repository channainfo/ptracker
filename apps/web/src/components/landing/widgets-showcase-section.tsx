    ...
    <section id="how-it-works" className="bg-muted/20 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl text-center">
          <h2 className="text-base font-semibold leading-7 text-primary">Live Demo</h2>
        ...
        <div className="mx-auto mt-12 max-w-md">
          <div className="flex items-center justify-center space-x-1 bg-card p-1 rounded-lg border border-border">
            <button
        ...
        <div className="mx-auto mt-16 max-w-6xl">
          <div className="relative">
            ...
            <div className={`relative mx-auto transition-all duration-500 ${
              ...
              {/* Frame Header */}
              <div className="bg-muted rounded-t-xl p-3">
                <div className="flex items-center space-x-2">
                  ...
                  <div className="flex-1 bg-muted/50 rounded px-3 py-1 text-xs text-muted-foreground text-center">
                    ptracker.com/dashboard
                  </div>
                </div>
              </div>
              
              {/* Widget Container */}
              <div className={`bg-card p-6 rounded-b-xl border-x border-b border-border transition-all duration-500 ${
              ...
              <div className="space-y-4">
                {features.map((feature, index) => {
                  ...
                  return (
                    <div 
                      key={feature.title}
                      className="bg-card p-4 rounded-lg border border-border max-w-xs animate-slide-up"
        ...
        <div className="mx-auto mt-16 max-w-2xl text-center">
          <div className="bg-gradient-to-r from-primary/20 to-purple-600/20 rounded-2xl p-8 border border-primary/30">
            ...
            <div className="flex flex-row gap-3 sm:gap-4 justify-center">
              <button className="inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base bg-primary text-primary-foreground rounded-lg font-semibold hover:bg-primary/90 transition-colors">
                <PlayIcon className="h-4 w-4 mr-2" />
                Try Interactive Demo
              </button>
              <button className="inline-flex items-center justify-center px-4 sm:px-6 py-2 sm:py-3 text-sm sm:text-base border border-border text-foreground rounded-lg font-semibold hover:bg-accent transition-colors">
